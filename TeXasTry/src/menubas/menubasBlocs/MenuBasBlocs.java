...
public class MenuBasBlocs extends JTabbedPane implements ChangeListener, Runnable{
	...
	public MenuBasBlocs(){
		...
		this.add("Code", new MenuBasBlocCode());
		this.add("Citation", new MenuBasBlocCitation());
		this.add("Mathématiques", new MenuBasBlocMaths());
		this.add("Note de bas de page", new MenuBasBlocNoteBasPage());
	}
