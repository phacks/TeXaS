...
La saisie de texte s'effectue directement sur celui-ci, alors que les éléments hors textes (mathématiques, tableaux, matrices, figures, titres, etc.) son créés à l'aide d'un ruban de création.
